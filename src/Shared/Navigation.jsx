          ...
          <div className="navbar-end">
            {user ? (
              <>
                ...
                <Link>
                  <button
                    className="btn md:btn-md btn-sm  bg-slate-800 text-white hover:bg-slate-950"
              ...
              <Link to="/login">
                <button className="btn btn-sm md:btn-md bg-slate-800 text-white hover:bg-slate-950">
                  Login
                </button>
              </Link>
            )}
